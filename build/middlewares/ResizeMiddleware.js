...
var ResizeMiddleware = /** @class */ (function () {
    ...
    ResizeMiddleware.resizeImage = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var fileName, width, height, ERROR_MESSAGE, filePath, thumbnailFilePath, error_1;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (isNaN(width) || isNaN(height)) {
                            return [2 /*return*/, res.status(401).send("".concat(ERROR_MESSAGE, ": Width and height should be a valid Integer"))];
                        }
